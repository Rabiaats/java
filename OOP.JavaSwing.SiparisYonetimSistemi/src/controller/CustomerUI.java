...
public class CustomerUI extends JFrame{
    ...
    public CustomerUI(Customer customer){
        ...
        // Customer da olusturdugumuz enum TYPE values lerini cekip combobox a ekledik
        ...
        btn_customer_save.addActionListener(e -> {
            JTextField[] checkList = {this.fld_customer_name, this.fld_customer_phone}; // dolmasini istedigim alanlari kontrol ediyoruz
